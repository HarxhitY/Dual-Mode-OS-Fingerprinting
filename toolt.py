...
def run_analysis(target_ip):
    ...
    def process_packet(packet):
        with warnings.catch_warnings():
            ...
            # Add a flag to track if packet has been processed
            processed = False

            packet_info = extract_packet_info(packet)
            if packet_info and len(packet_info) == 8 and packet[IP].src == target_ip and not processed:
                ...
                # Set the flag to True to indicate packet processing
                processed = True
    ...
    def timeout_handler(signum, frame):
        ...
        print("Could not connect after 30 mins")
        sys.exit(1)
